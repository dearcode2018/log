/**
 * 描述: 
 * ExternalAccessLogMapperTest.java
 * 
 * @author qye.zheng
 *  version 1.0
 */
...
public final class ExternalAccessLogMapperTest extends BaseTest {
	...
	public void testInsert() {
		try {
			...
			entity.setBusinessId(UUID.randomUUID().toString().replace("-", ""));
			entity.setAccessCode("100001");
			//entity.setSource("调用方名称");
			entity.setRequestParam("{\"name\":\"zhangsan\"}");
			entity.setResponseResult("{\"code\": \"200\"}");
			entity.setRequestAddr("192.168.5.10");
			entity.setEndureSecond(300);
			entity.setRemark("备注");
	...
	public void testUpdate() {
		try {
			ExternalAccessLogEntity entity = new ExternalAccessLogEntity();
			entity.setBusinessId("ce2032ee9f8f452f96c52d9c4817aab6");
			entity.setResponseResult("{\"code\": \"400\"}");
			entity.setEndureSecond(300);
